...
//=============================================================================
class IM_BulletHE extends IM_Bullet;

defaultproperties
{
     HitEffects(0)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(1)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(2)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(3)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(4)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(5)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(6)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(7)=Class'BWBP_SKC_Fix.IE_BulletHE'
     HitEffects(8)=Class'BWBP_SKC_Fix.IE_BulletHE'

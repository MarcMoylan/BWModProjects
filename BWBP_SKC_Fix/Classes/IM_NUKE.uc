...
// IM_NUKE.
//
// ImpactManager subclass for unholy mother of rocket launchers
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2005 RuneStorm. All Rights Reserved.
//=============================================================================
class IM_NUKE extends BCImpactManager;
...
defaultproperties
{
     SurfaceRange=1024.000000
     MinFluidDepth=128.000000
     HitEffects(0)=Class'BWBP_SKC_Fix.IE_NukeSuper'
//     HitEffects(1)=Class'BWBP_SKC_Fix.IE_Nuclear'
//     HitEffects(2)=Class'BWBP_SKC_Fix.IE_SgtKellyNuke'
     HitDecals(0)=Class'BallisticFix.AD_Explosion'
     HitSounds(0)=Sound'BWBP_SKC_Sounds.Misc.LAW-NukeBlast'
     HitSoundVolume=8.000000
     HitSoundRadius=8192.000000
     EffectBackOff=512.000000
}

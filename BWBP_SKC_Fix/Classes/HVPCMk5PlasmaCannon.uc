...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BWBP_SKC_Tex.XavPlasCannon.BigIcon_Xav'
     ...
     CrosshairCfg=(Pic1=Texture'BallisticUI2.Crosshairs.M50Out',Pic2=Texture'BallisticUI2.Crosshairs.Misc4',USize2=256,VSize2=256,Color2=(B=153,G=168,R=170,A=83),StartSize2=84)
     ...
     AimSpread=(X=(Min=-150.000000,Max=150.000000),Y=(Min=-150.000000,Max=150.000000))
     ViewAimFactor=0.250000
     ViewRecoilFactor=0.450000
     ChaosSpeedThreshold=380.000000
     ChaosAimSpread=(X=(Min=-1900.000000,Max=1900.000000),Y=(Min=-1900.000000,Max=1900.000000))
     RecoilYawFactor=0.100000
     RecoilXFactor=0.300000
     RecoilYFactor=0.300000
     RecoilMax=256.000000
     RecoilDeclineTime=0.750000
     FireModeClass(0)=Class'BWBP_SKC_Fix.HVPCMk5PrimaryFire'
     FireModeClass(1)=Class'BWBP_SKC_Fix.HVPCMk5SecondaryFire'
     ...
     InventoryGroup=0
     GroupOffset=10
     PickupClass=Class'BWBP_SKC_Fix.HVPCMk5Pickup'
     PlayerViewOffset=(X=-3.000000,Y=9.500000,Z=-9.500000)
     BobDamping=1.600000
     AttachmentClass=Class'BWBP_SKC_Fix.HVPCMk5Attachment'
     IconMaterial=Texture'BWBP_SKC_Tex.XavPlasCannon.SmallIcon_Xav'
     ...
     Skins(1)=Texture'BWBP_SKC_Tex.XavPlasCannon.Xav-SkinMk2'
     bFullVolume=True
     SoundVolume=64

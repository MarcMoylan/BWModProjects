...
simulated function PostBeginPlay()
{
	...
	BFireMode[0].RecoilPerShot=128.000000;
...
defaultproperties
{
     ...
     CrosshairInfo=(SpreadRatios=(Y1=0.300000,Y2=0.300000))
     GunLength=0.000000
     bUseSpecialAim=True
     AimSpread=(X=(Min=0.000000,Max=0.000000),Y=(Min=0.000000,Max=0.000000))
     ChaosAimSpread=(X=(Min=-8.000000,Max=8.000000),Y=(Min=-8.000000,Max=8.000000))
     ...
     Mesh=SkeletalMesh'BWBP_SKC_Anim.X83A1_Turret'
     DrawScale=0.650000

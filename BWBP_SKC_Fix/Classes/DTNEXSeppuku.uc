...
defaultproperties
{
     ...
     FemaleSuicides(0)="%o pulled off a 1337 samurai move."
     FemaleSuicides(1)="%o wants to be a samurai!"
     FemaleSuicides(2)="%o performed seppuku."
     MaleSuicides(0)="%o pulled off a 1337 samurai move."
     MaleSuicides(1)="%o wants to be a samurai!"
     MaleSuicides(2)="%o performed seppuku."
     BloodManagerName="BallisticFix.BloodMan_Lightning"
     DamageDescription=",Electro,Hazard"
     WeaponClass=Class'BWBP_SKC_Fix.NEXPlasEdge'
     DeathString="%o stared a bit too closely at %k's demonstration."
     MaleSuicide="%o pulled off a 1337 samurai move."
     bArmorStops=False
     bInstantHit=True
     bNeverSevers=True
     bFlaming=True

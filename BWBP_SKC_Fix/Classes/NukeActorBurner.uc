...
// NukeActorBurner.
//
// A very long lasting radiation poison. Does 10 damage every 5 seconds. 60 seconds.
// 120 DMG total. This is not survivable without medpacks.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2005 RuneStorm. All Rights Reserved.
//=============================================================================
class NukeActorBurner extends BallisticEmitter
	placeable;
...
defaultproperties
{
     DamageType=Class'BWBP_SKC_Fix.DT_NukeRadiation'
     Damage=5
     BurnTime=60.000000
     AutoDestroy=True
     bNoDelete=False
     bDynamicLight=True
     AmbientSound=Sound'BWBP_SKC_SoundsExp.Nuke.Nuke-Geiger'
     bFullVolume=True
     bHardAttach=True
     SoundVolume=255

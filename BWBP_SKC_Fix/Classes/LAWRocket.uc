...
defaultproperties
{
     ...
     ImpactDamageType=Class'BWBP_SKC_Fix.DTLAW'
     ImpactManager=Class'BWBP_SKC_Fix.IM_LAWSmall'
     ...
     MyDamageType=Class'BWBP_SKC_Fix.DTLAW'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DTLAWRadius'
     RollRange=100000
     ...
     TrailClass=Class'BWBP_SKC_Fix.LAWRocketTrail'

...
//=============================================================================
class PUMARepeater extends BallisticCamoWeapon;
var bool		bFirstDraw;
var bool		bPierce;
...
defaultproperties
{
     ...
     CamoMaterials[0]=Shader'BWBP_SKC_TexExp.PUMA.PUMA-Shine'
     CamoMaterials[1]=Shader'BWBP_SKC_TexExp.PUMA.PUMA-ShineUrban'// Zeighe.
     CamoMaterials[2]=Shader'BWBP_SKC_TexExp.PUMA.PUMA-ShineGreen'	// Zdlof.
     CamoMaterials[3]=Shader'BWBP_SKC_TexExp.PUMA.PUMA-ShineBlue' // Cbleaf.
     ...
     WeaponModes(0)=(ModeName="Airburst: Off",ModeID="WM_FullAuto")
     WeaponModes(1)=(ModeName="Airburst: Proximity",ModeID="WM_FullAuto")
     WeaponModes(2)=(ModeName="Airburst: Range",ModeID="WM_FullAuto")
     CurrentWeaponMode=1
     SightPivot=(Pitch=150)
     SightOffset=(X=0.000000,Y=0.250000,Z=16.300000)
     ...
     FireModeClass(0)=Class'BWBP_SKC_Fix.PumaPrimaryFire'
     FireModeClass(1)=Class'BWBP_SKC_Fix.PumaSecondaryFire'
     AIRating=0.600000
     ...
     InventoryGroup=7
     PickupClass=Class'BWBP_SKC_Fix.PumaPickup'
     PlayerViewOffset=(X=-4.000000,Y=6.000000,Z=-11.000000)
     BobDamping=1.700000
     PutDownTime=0.800000
     BringUpTime=1.000000
     AttachmentClass=Class'BWBP_SKC_Fix.PumaAttachment'

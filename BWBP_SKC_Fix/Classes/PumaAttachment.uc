...
//=============================================================================
class PumaAttachment extends BallisticCamoAttachment;
...
simulated function PostNetBeginPlay()
{
	if (CamoIndex != default.CamoIndex) 
		Skins[5] = CamoWeapon.default.CamoMaterials[CamoIndex];
}
...
defaultproperties
{
     CamoWeapon=Class'BWBP_SKC_Fix.PUMARepeater'
     BrassClass=Class'BWBP_SKC_Fix.Brass_Puma'
     bHeavy=True
     Mesh=SkeletalMesh'BWBP_SKC_AnimExp.TP_PUMA'

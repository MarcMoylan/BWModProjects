...
//=============================================================================
class CYLOMk3MachineGun extends BallisticWeapon;
...
defaultproperties
{
     ...
     MeleeFireClass=Class'BWBP_SKC_Fix.CYLOMeleeFire'
     ...
     ClipHitSound=(Sound=Sound'BallisticSounds2.M50.M50ClipHit',Volume=1.500000)
     ...
     FireModeClass(0)=Class'BWBP_SKC_Fix.CYLOMk3PrimaryFire'
     FireModeClass(1)=Class'BWBP_SKC_Fix.CYLOMk3SecondaryFire'
     ...
     InventoryGroup=4
     GroupOffset=10
     PickupClass=Class'BWBP_SKC_Fix.CYLOMk3Pickup'
     PlayerViewOffset=(X=8.000000,Z=-14.000000)
     BobDamping=2.000000
     AttachmentClass=Class'BWBP_SKC_Fix.CYLOMk3Attachment'
     IconMaterial=Texture'BWBP_SKC_Tex.CYLO.SmallIcon_CYLO'
     IconCoords=(X2=127,Y2=31)
     ItemName="CYLO Urban Assault Weapon Mk2"
     LightType=LT_Pulse
     ...
     Mesh=SkeletalMesh'BWBP_SKC_Anim.CYLO_FP'
     DrawScale=0.400000
}
//=============================================================================
// DragonsToothBladeEffectR. Red blade effect.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class DragonsToothBladeEffectR extends BallisticEmitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         ColorMultiplierRange=(X=(Min=0.800000),Y=(Min=0.000000,Max=0.400000),Z=(Min=0.000000,Max=0.000000))
         FadeOutStartTime=0.330562
         CoordinateSystem=PTCS_Relative
         MaxParticles=5
         StartSizeRange=(X=(Min=0.000000,Max=14.799000),Y=(Min=0.000000,Max=1.799000),Z=(Min=0.000000,Max=1.799000))
     ...
     End Object
     Emitters(0)=BeamEmitter'BWBP_SKC_Fix.DragonsToothBladeEffectR.BeamEmitter3'

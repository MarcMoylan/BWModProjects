...
function DoFireEffect()
{
	...
	if (Other != None && (Other.bWorldGeometry || Mover(Other) != none))
		GetChargeControl().FireShot(Start, HitLocation, Dist, Other != None, HitNormal, Instigator, Other);
	else
		GetChargeControl().FireShot(Start, HitLocation, Dist, Other != None, HitNormal, Instigator, None);
	}
...
defaultproperties
{
     ...
     bPenetrate=False
     ClipFinishSound=(Sound=Sound'BWBP2-Sounds.LightningGun.LG-FireStart2',Volume=1.000000,Radius=48.000000,bAtten=True)
     Damage=1
     DamageHead=2
     DamageLimb=1
     DamageType=Class'BWBP_SKC_Fix.DTCYLORifle'
     DamageTypeArm=Class'BWBP_SKC_Fix.DTCYLORifle'
     DamageTypeHead=Class'BWBP_SKC_Fix.DTCYLORifle'
     DryFireSound=(Sound=Sound'BWBP2-Sounds.LightningGun.LG-OverHeat',Volume=1.000000)
     FireChaos=0.010000
	 FireAnim=""
     FireEndAnim=
     FireRate=0.0631500

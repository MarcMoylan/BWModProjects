...
{
     DisableDGV(1)=1
     Emitters(0)=SpriteEmitter'BallisticFix.IE_HVCRedLightning.SpriteEmitter2'

     Emitters(1)=BeamEmitter'BallisticFix.IE_HVCRedLightning.BeamEmitter4'

     Emitters(2)=SpriteEmitter'BallisticFix.IE_HVCRedLightning.SpriteEmitter3'

     Emitters(3)=SpriteEmitter'BallisticFix.IE_HVCRedLightning.SpriteEmitter4'
     ...
     End Object
     Emitters(4)=SpriteEmitter'BWBP_SKC_Fix.IE_HVPCGeneral.SpriteEmitter12'
     ...
     End Object
     Emitters(5)=SpriteEmitter'BWBP_SKC_Fix.IE_HVPCGeneral.SpriteEmitter13'
     ...
     End Object
     Emitters(7)=SpriteEmitter'BWBP_SKC_Fix.IE_HVPCGeneral.SpriteEmitter15'

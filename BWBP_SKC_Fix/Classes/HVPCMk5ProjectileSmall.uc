...
defaultproperties
{
     ImpactManager=Class'BWBP_SKC_Fix.IM_HVPCProjectileSmall'
     PenetrateManager=Class'BWBP_SKC_Fix.IM_HVPCProjectileSmall'
     bPenetrate=True
     bRandomStartRotaion=False
     AccelSpeed=150000.000000
     TrailClass=Class'BWBP_SKC_Fix.HVPCSmallTrailEmitter'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DTPlasmaChargeSmall'
     bUsePositionalDamage=True
     Damage=30
     DamageHead=65
     DamageLimb=20
     DamageTypeHead=Class'BWBP_SKC_Fix.DTPlasmaChargeHeadSmall'
     SplashManager=Class'BallisticFix.IM_ProjWater'
     Speed=200.000000
     MaxSpeed=2000000.000000
     DamageRadius=122.000000
     MomentumTransfer=12500.000000
     MyDamageType=Class'BWBP_SKC_Fix.DTPlasmaChargeSmall'
     LightType=LT_Steady

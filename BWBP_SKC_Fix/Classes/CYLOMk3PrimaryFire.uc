...
//=============================================================================
class CYLOMk3PrimaryFire extends BallisticInstantFire;
...
defaultproperties
{
     ...
     BallisticFireSound=(Sound=Sound'BWBP_SKC_Sounds.M514H.M514H-Fire',Pitch=1.200000,Volume=1.100000,Slot=SLOT_Interact,bNoOverride=False)

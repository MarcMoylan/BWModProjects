...
function ManualDetonate(bool bBig)
{
	if (bBig)
	{
	   FlakClass=Class'BWBP_SKC_Fix.LonghornClusterGrenadeImpact';
       Damage*=2.00;
       DamageRadius*=2.00;
	   bArtillerate = True;
	 }
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	if (bArtillerate)
	    ImpactManager=Class'BWBP_SKC_Fix.IM_AirGrenade';
...
defaultproperties
{
     ...
     DrawScale=0.500000
     FlakClass=Class'BWBP_SKC_Fix.LonghornClusterGrenadeFlak'
     flakcount=6
     ImpactDamage=70
     ImpactDamageType=Class'BWBP_SKC_Fix.DT_LonghornBigDirect'
     ImpactManager=Class'BWBP_SKC_Fix.IM_SMARTGrenade'
     LifeSpan=20
     ...
     MyDamageType=Class'BWBP_SKC_Fix.DT_LonghornBigRadius'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DT_LonghornBigRadius'

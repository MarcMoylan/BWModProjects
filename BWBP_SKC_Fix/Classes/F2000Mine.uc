...
//     DetonateSound=Sound'BallisticSounds_25.OA-AR.OA-AR_GrenadeBeep'
     DetonateSound=Sound'BWBP_SKC_SoundsExp.MARS.MARS-MineAlarm'
     Health=40
     ImpactManager=Class'BallisticFix.IM_Grenade'
     ImpactManager2=Class'BWBP_SKC_Fix.IM_F2000Wave'
     StartDelay=0.300000
     MyShotDamageType=Class'BWBP_SKC_Fix.DT_MARSMineShot'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DT_MARSMineDet'
...
//     Damage=110.000000
     ...
     ShockRadius=768.000000
     DrawScale=0.500000
     MyDamageType=Class'BWBP_SKC_Fix.DT_MARSMineDet'
     StaticMesh=StaticMesh'BWBP_SKC_StaticExp.MARS.MARS3Grenade'

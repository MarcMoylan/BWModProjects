//=============================================================================
// IM_FLAKGrenadeCluster.
//
// ImpactManager subclass for FLAK flak!
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2005 RuneStorm. All Rights Reserved.
//=============================================================================
class IM_FLAKGrenadeCluster extends BCImpactManager;
...
defaultproperties
{
     ...
     HitEffects(0)=Class'BWBP_SKC_Fix.IE_FLAKCluster
     HitDecals(0)=Class'BallisticFix.AD_Explosion'
     HitSounds(0)=SoundGroup'BWBP_SKC_Sounds.Misc.M202-Impact'

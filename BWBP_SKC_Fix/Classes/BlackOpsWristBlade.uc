...
defaultproperties
{
     ...
     MagAmmo=1
     bNoMag=True
     CrosshairCfg=(Pic1=Texture'BallisticUI2.Crosshairs.X3OutA',Pic2=Texture'BallisticUI2.Crosshairs.M50In',USize1=256,VSize1=256,Color1=(B=159,G=64,R=0),Color2=(B=255),StartSize1=98,StartSize2=101)
     CrosshairInfo=(SpreadRatios=(X1=0.250000,Y1=0.375000,X2=1.000000,Y2=1.000000),MaxScale=8.000000)
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'BWBP_SKC_Fix.BlackOpsWristBladePrimaryFire'
     FireModeClass(1)=Class'BWBP_SKC_Fix.BlackOpsWristBladeSecondaryFire'
     ...
     GroupOffset=5
     PickupClass=Class'BWBP_SKC_Fix.BlackOpsWristBladePickup'
     PlayerViewOffset=(X=35.000000,Y=50.000000,Z=-40.000000)
     BobDamping=1.000000
     AttachmentClass=Class'BWBP_SKC_Fix.BlackOpsWristBladeAttachment'
     IconMaterial=Texture'BWBP_SKC_Tex.BlkOpsBlade.SmallIcon_WristBld'
     IconCoords=(X2=127,Y2=31)
     ItemName="X5W Black Ops Blade"
     Mesh=SkeletalMesh'BWBP_SKC_Anim.BlackOpsWristBlade'
     DrawScale=1.250000
}

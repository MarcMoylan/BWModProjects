//=============================================================================
// LonghornGrenadeTrail.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2007 RuneStorm. All Rights Reserved.
//=============================================================================
class LonghornGrenadeTrail extends BallisticEmitter;
...
simulated function SetupColor(int TeamNum)
{
	...
	Emitters[1].ColorMultiplierRange.X.Max=0.20;
	Emitters[1].ColorMultiplierRange.X.Min=0.10;
	Emitters[1].ColorMultiplierRange.Y.Max=0.60;
	Emitters[1].ColorMultiplierRange.Y.Min=0.20;
	Emitters[1].ColorMultiplierRange.Z.Max=0.50;
	Emitters[1].ColorMultiplierRange.Z.Min=0.30;

	Emitters[5].ColorMultiplierRange.X.Max=0.20;
	Emitters[5].ColorMultiplierRange.X.Min=0.10;
	Emitters[5].ColorMultiplierRange.Y.Max=0.60;
	Emitters[5].ColorMultiplierRange.Y.Min=0.20;
	Emitters[5].ColorMultiplierRange.Z.Max=0.50;
	Emitters[5].ColorMultiplierRange.Z.Min=0.30;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter3'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(2)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(3)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter5'
     ...
     End Object
     Emitters(4)=TrailEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.TrailEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         StartVelocityRange=(X=(Min=-256.000000,Max=256.000000),Y=(Min=-256.000000,Max=256.000000),Z=(Min=200.000000,Max=800.000000))
     End Object
     Emitters(5)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter6'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter28
         ...
         SizeScale(1)=(RelativeTime=0.50000,RelativeSize=0.700000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter28'
    ...
    LifetimeRange=(Min=0.401000,Max=0.401000)
     End Object
     Emitters(7)=SpriteEmitter'BWBP_SKC_Fix.LonghornGrenadeTrail.SpriteEmitter7'

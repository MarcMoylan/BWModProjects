...
// M30A2Pickup.
//=============================================================================
class M30A2Pickup extends BallisticCamoPickup
	placeable;
...
simulated function PostNetReceive()
{
	if (CamoIndex != OldCamoIndex)
	{
		...
		if (CamoIndex == 1) //M30A2
		{
     			PickupMessage="You picked up the M30A2 Tactical Rifle";
			Skins[0]=class<BallisticCamoWeapon>(InventoryType).default.CamoMaterials[3];
			Skins[1]=class<BallisticCamoWeapon>(InventoryType).default.CamoMaterials[4];
		}
		else if (CamoIndex == 0) //M30A1
		{
     			PickupMessage="You picked up the M30A1 Tactical Rifle";
			Skins[0]=class<BallisticCamoWeapon>(InventoryType).default.CamoMaterials[1];
			Skins[1]=class<BallisticCamoWeapon>(InventoryType).default.CamoMaterials[2];
		}
...
defaultproperties
{
     ...
     InventoryType=Class'BWBP_SKC_Fix.M30A2AssaultRifle'
     RespawnTime=20.000000
     PickupMessage="You picked up the M30 Tactical Rifle"

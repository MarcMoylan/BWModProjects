...
//=============================================================================
class NEXBladeEffect extends BallisticEmitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'BWBP_SKC_Fix.NEXBladeEffect.BeamEmitter3'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Fix.NEXBladeEffect.SpriteEmitter9'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BWBP_SKC_Fix.NEXBladeEffect.SpriteEmitter10'
     ...
     End Object
     Emitters(3)=SparkEmitter'BWBP_SKC_Fix.NEXBladeEffect.SparkEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
        ...
        StartVelocityRange=(X=(Min=80.000000,Max=80.000000))
     End Object
     Emitters(4)=SpriteEmitter'BWBP_SKC_Fix.NEXBladeEffect.SpriteEmitter4'
     ...
     Begin Object Class=SparkEmitter Name=SparkEmitter3
        ...
        StartVelocityRange=(X=(Min=80.000000,Max=300.000000),Y=(Min=-80.000000,Max=80.000000),Z=(Min=-200.000000,Max=200.000000))
     End Object
     Emitters(5)=SparkEmitter'BWBP_SKC_Fix.NEXBladeEffect.SparkEmitter3'

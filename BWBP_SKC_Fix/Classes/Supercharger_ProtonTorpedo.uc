...
defaultproperties
{
     ...
     ComboAmmoCost=10
     ComboDamageType=Class'BWBP_SKC_Fix.DTCYLORifle'
     ComboDamageType2=Class'BallisticFix.DTRX22ABurned'
     ImpactManager=Class'BWBP_SKC_Fix.IM_EMPRocket'
     AccelSpeed=600.000000
     TrailClass=Class'BWBP_SKC_Fix.Supercharger_PhotonTrail'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DT_BFGCharge'
     ...
     MyDamageType=Class'BWBP_SKC_Fix.DT_BFGCharge'
     LightHue=180
     LightSaturation=100

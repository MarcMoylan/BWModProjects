...
defaultproperties
{
     HitEffects(0)=Class'BWBP_SKC_Fix.IE_IncBulletConcrete'
     HitEffects(1)=Class'BWBP_SKC_Fix.IE_IncBulletConcrete'
     HitEffects(2)=Class'BWBP_SKC_Fix.IE_IncBulletDirt'
     HitEffects(3)=Class'BWBP_SKC_Fix.IE_IncBulletMetal'

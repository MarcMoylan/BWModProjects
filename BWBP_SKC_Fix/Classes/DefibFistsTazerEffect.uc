...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'BWBP_SKC_Fix.DefibFistsTazerEffect.BeamEmitter3'
     ...
     End Object
     Emitters(1)=SpriteEmitter'BWBP_SKC_Fix.DefibFistsTazerEffect.SpriteEmitter9'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter10
         ...
         CoordinateSystem=PTCS_Relative
         StartLocationOffset=(X=0.000000,Y=0.000000)
     ...
     End Object
     Emitters(2)=SpriteEmitter'BWBP_SKC_Fix.DefibFistsTazerEffect.SpriteEmitter10'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         FadeInEndTime=0.029000
         CoordinateSystem=PTCS_Relative
         StartLocationOffset=(X=0.000000,Y=-6.000000)
         //StartLocationRange=(X=(Min=-1.000000,Max=1.000000),Y=(Min=-1.500000,Max=1.500000),Z=(Min=-1.500000,Max=1.500000))
         StartSizeRange=(X=(Min=3.000000,Max=4.000000),Y=(Min=3.000000,Max=4.000000),Z=(Min=3.000000,Max=4.000000))
         Texture=Texture'BallisticEffects.Particles.FlareB1'
         LifetimeRange=(Min=0.100000,Max=0.100000)
         StartVelocityRange=(X=(Min=80.000000,Max=80.000000))
     End Object
     Emitters(3)=SpriteEmitter'BWBP_SKC_Fix.DefibFistsTazerEffect.SpriteEmitter4'

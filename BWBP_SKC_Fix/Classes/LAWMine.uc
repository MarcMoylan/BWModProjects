...
function Shockwave(vector HitLocation)
{
	...
	foreach RadiusActors( class 'Actor', A, ShockRadius, Location )
	{
		...
		if (A.bCanBeDamaged)
		{
			class'BallisticDamageType'.static.Hurt(A, 25.0, Instigator, A.Location, Normal(A.Location - Location)*500, class'DTLAWPulse');
		}
...
//     DetonateSound=Sound'BallisticSounds_25.OA-AR.OA-AR_GrenadeBeep'
     DetonateSound=Sound'BWBP_SKC_SoundsExp.LAW.LAW-MineAlarm'
     Health=70
     ImpactManager=Class'BallisticFix.IM_RPG'
     ImpactManager2=Class'BWBP_SKC_Fix.IM_LAWWave'
     StartDelay=0.300000
     MyShotDamageType=Class'BWBP_SKC_Fix.DTLAWShot'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DTLAWMineDet'
...
//     Damage=60.000000
     ...
     MyDamageType=Class'BWBP_SKC_Fix.DTLAWMineDet'

...
defaultproperties
{
     ImpactManager=Class'BWBP_SKC_Fix.IM_BFGProjectileSmall'
     PenetrateManager=Class'BWBP_SKC_Fix.IM_BFGProjectileSmall'
     bPenetrate=True
     bRandomStartRotaion=False
     AccelSpeed=190000.000000
     TrailClass=Class'BWBP_SKC_Fix.BFGSmallTrailEmitter'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DT_BFGChargeSmall'
     bUsePositionalDamage=True
     Damage=60
     DamageHead=125
     DamageLimb=40
     DamageTypeHead=Class'BWBP_SKC_Fix.DT_BFGChargeSmall'
     SplashManager=Class'BallisticFix.IM_ProjWater'
     Speed=250.000000
     MaxSpeed=2000000.000000
     DamageRadius=122.000000
     MomentumTransfer=12500.000000
     MyDamageType=Class'BWBP_SKC_Fix.DT_BFGChargeSmall'
     LightType=LT_Steady

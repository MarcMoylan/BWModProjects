...
//=============================================================================
class TraceEmitter_LS14B extends BCTraceEmitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.275000,Color=(B=255,G=255,R=0,A=255))
         ColorScale(2)=(RelativeTime=0.496429,Color=(B=255,G=192,R=64,A=255))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=88,G=43,R=0,A=255))
     ...
     End Object
     Emitters(1)=BeamEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.BeamEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.SpriteEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter2
         ...
         StartVelocityRange=(X=(Min=1.000000,Max=1.000000))
     End Object
     Emitters(3)=BeamEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.BeamEmitter2'
     ...
     Begin Object Class=SparkEmitter Name=SparkEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.357143,Color=(G=64,B=255,A=255))
     ...
     End Object
     Emitters(4)=SparkEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.SparkEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=64,G=192,R=0,A=255))
         ...
         StartVelocityRange=(X=(Min=1.000000,Max=1.000000))
     End Object
     Emitters(5)=BeamEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.BeamEmitter3'
     ...
     End Object
     Emitters(6)=SpriteEmitter'BWBP_SKC_Fix.TraceEmitter_LS14B.SpriteEmitter1'

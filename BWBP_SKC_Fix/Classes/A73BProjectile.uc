...
//=============================================================================
class A73BProjectile extends BallisticProjectile;
...
defaultproperties
{
     ImpactManager=Class'BWBP_SKC_Fix.IM_A73BProjectile'
     PenetrateManager=Class'BWBP_SKC_Fix.IM_A73BProjectile'
     bPenetrate=True
     bRandomStartRotaion=False
     bTearOnExplode=False
     AccelSpeed=70000.000000
     TrailClass=Class'BWBP_SKC_Fix.A73BTrailEmitter'
     MyRadiusDamageType=Class'BWBP_SKC_Fix.DTA73BSkrith'
     bUsePositionalDamage=True
     Damage=40
     DamageHead=100
     DamageLimb=20
     DamageTypeHead=Class'BWBP_SKC_Fix.DTA73BSkrithHead'
     SplashManager=Class'BallisticFix.IM_ProjWater'
     Speed=85.000000
     MaxSpeed=4500.000000
     DamageRadius=96.000000
     MomentumTransfer=150.000000
     MyDamageType=Class'BWBP_SKC_Fix.DTA73BSkrith'
     LightType=LT_Steady
